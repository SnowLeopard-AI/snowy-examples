...
import type chat from '../agent/chat/agent.js';
 ...
 */
export type POSTApiChatInput = InferInput<typeof chat['inputSchema']>;

/**
 * Output type for route: POST /api/chat
 */
export type POSTApiChatOutput = InferOutput<typeof chat['outputSchema']>;

/**
 * Input schema type for route: POST /api/chat
 */
export type POSTApiChatInputSchema = typeof chat extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/chat
 */
export type POSTApiChatOutputSchema = typeof chat extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/chat': {
				...
				stream: typeof chat extends { stream?: infer S } ? S : false;
				params: never;
			};
	'POST /api/chat/init': {
				inputSchema: never;
